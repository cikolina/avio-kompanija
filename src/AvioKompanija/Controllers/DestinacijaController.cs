...
namespace AvioKompanija.Controllers
{
    public class DestinacijaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,AerodromId,Grad,Drzava,Img")] Destinacija destinacija)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AerodromId,Grad,Drzava,Img")] Destinacija destinacija)
        {
